...
Practical reference for the current tool-migration state in `packages/devpass-code`.
...
Tool tests should use the existing Effect helpers in `packages/devpass-code/test/lib/effect.ts`:
