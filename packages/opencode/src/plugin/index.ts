...
import { LlmGatewayAuthPlugin, LlmGatewayDevPassAuthPlugin } from "./llmgateway/llmgateway"
...
// devpass-code ships only the LLM Gateway providers.
function internalPlugins(): PluginInstance[] {
  return [LlmGatewayAuthPlugin, LlmGatewayDevPassAuthPlugin]
}
